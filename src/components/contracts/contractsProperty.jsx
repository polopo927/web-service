...
import { ContractsPopupProperty } from './contractsPopupProperty';

export const ContractsProperty = () => {
    ...
    <section className="contracts">
      <div className="container__contracts">
        <div className="contracts__header">
          <span className="contracts__header-info">Договоры(Имущество)</span>
        </div>
      ...
      {isPopupOpen && <ContractsPopupProperty addRow={addRow} closePopup={closePopup} />}
    </section>
  );
}
